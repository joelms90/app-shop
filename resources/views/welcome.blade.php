                ...
                <div class="section text-center section-landing">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h2 class="title">¿Por qué comprar aquí?</h2>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="info">
                                    ...
                                    <p>Atendemos rápidamente cualquier consulta que tengas vía chat.</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="info">
                                    ...
                                    <p>Todo pedido que realices será confirmado a través de una llamada. Si no confías en los pagos en línea puedes pagar a contra entrega tu pedido.</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="info">
                                    ...
                                    <p>Los pedidos que realices sólo los conceras tú a través de tu panel de usuario. Nadie más tiene acceso a esta información.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="team-player">
                                    <img src="{{$product->featured_image_url}}" alt="Imagen No Disponible" class="img-raised img-circle">
                                    <h4 class="title">
