                ...
                <div class="section text-center">
                    ...
                    <div class="team">
                        <a href="{{url('/admin/products/create')}}"class="btn btn-primary btn-round">
                          <i class="fa fa-clone" ></i>  Nuevo Producto
                        </a>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class=class="text-center">$ {{$product->price}}</td>
                                    <td class="td-actions text-center">
                                     ...
                                     <button type="button" rel="tooltip" title="Ver producto" class="btn btn-info btn-simple btn-xs">
                                        ...
                                        <a href= "{{url('/admin/products/'.$product->id.'/images')}}"  rel="tooltip" title="Ímágenes del producto" class="btn btn-warning btn-simple btn-xs">
